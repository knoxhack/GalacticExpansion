...
public class BaseRocketEngine implements IRocketEngine {
    ...
    public double getHeatGeneration() {
        ...
        // Calculate heat generation based on thrust and efficiency
        // Higher thrust and lower efficiency results in more heat
        return thrust * (1.0 - efficiency) * 0.5;
    }
    ...
    public double getHeatGeneration() {
        // For NeoForge 1.21.5 compatibility
        // Calculate heat generation based on thrust and efficiency
        // Higher thrust = more heat, higher efficiency = less heat
        return thrust * (1.0 - (efficiency * 0.5)) * 0.75;
    }
