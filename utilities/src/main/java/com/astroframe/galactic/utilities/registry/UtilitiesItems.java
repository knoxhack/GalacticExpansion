...
public class UtilitiesItems {
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(
            ForgeRegistries.ITEMS, GalacticUtilities.MOD_ID);

    // Register block items
    public static final RegistryObject<Item> SIMPLE_UTILITY_BLOCK_ITEM = ITEMS.register(
            "simple_utility_block", 
            () -> new BlockItem(UtilitiesBlocks.SIMPLE_UTILITY_BLOCK.get(), new Item.Properties()));
    
    public static final RegistryObject<Item> DATA_LOGGER_ITEM = ITEMS.register(
            "data_logger", 
            () -> new BlockItem(UtilitiesBlocks.DATA_LOGGER.get(), new Item.Properties()));
    
    // Register regular items
    public static final RegistryObject<Item> HAND_SCANNER = ITEMS.register(
            "hand_scanner", 
            () -> new Item(new Item.Properties().stacksTo(1)));
    
    public static final RegistryObject<Item> CIRCUIT_BOARD = ITEMS.register(
            "circuit_board", 
