...
public class SpaceItems {
    ...
    public static final Supplier<Item> SPACE_SUIT_HELMET = ITEMS.register("space_suit_helmet",
            () -> new SpaceSuitItem(net.minecraft.world.item.ArmorItem.Type.valueOf("HELMET"), new Item.Properties().stacksTo(1)));
    
    public static final Supplier<Item> SPACE_SUIT_CHESTPLATE = ITEMS.register("space_suit_chestplate",
            () -> new SpaceSuitItem(net.minecraft.world.item.ArmorItem.Type.valueOf("CHESTPLATE"), new Item.Properties().stacksTo(1)));
    
    public static final Supplier<Item> SPACE_SUIT_LEGGINGS = ITEMS.register("space_suit_leggings",
            () -> new SpaceSuitItem(net.minecraft.world.item.ArmorItem.Type.valueOf("LEGGINGS"), new Item.Properties().stacksTo(1)));
    
    public static final Supplier<Item> SPACE_SUIT_BOOTS = ITEMS.register("space_suit_boots",
            () -> new SpaceSuitItem(net.minecraft.world.item.ArmorItem.Type.valueOf("BOOTS"), new Item.Properties().stacksTo(1)));
